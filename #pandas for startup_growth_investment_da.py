#pandas for startup_growth_investment_data.csv
import pandas as pd
...
#print last rows 
print('df last two rows',df.tail(2))
#print first three rows
print('df first two rows',df.head(2))
...
Industry_StartupName = df[['Industry','Startup Name']]
print('acess the multiple colums:df:')
print(Industry_StartupName)
...
second_row3 = df.loc[3:4]
print(second_row3)
#Conditional selection of rows using .loc
second_row4 = df.loc[df['Country'] == 'Germany','Year Founded']
#Selecting a single column using .loc
second_row5 = df.loc[2:3,'Industry']
print(second_row5)
#Selecting multiple columns using .loc
second_row6 = df.loc[3:4,['Number of Investors','Growth Rate (%)']]
print(second_row6)
#Selecting a slice of columns using .loc
second_row7 = df.loc[2:5,'Year Founded':'Funding Rounds']
print(second_row7)
#Combined row and column selection using .loc
second_row8 = df.loc[df['Country'] == 'India', 'Valuation (USD)']
print(second_row8)
