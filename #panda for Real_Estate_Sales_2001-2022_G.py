...
#print last rows 
print('df last four rows',df.tail(4))
#print first three rows
print('df first four rows',df.head(4))
...
AssessedValue_SaleAmount = df[['Assessed Value','Sale Amount']]
print('acess the multiple colums:df:')
print(AssessedValue_SaleAmount)
...
second_row4 = df.loc[df['Address'] == '323 BEAVER ST','List Year']
print(second_row4)
#Selecting a single column using .loc
second_row5 = df.loc[2:3,'Property Type']
print(second_row5)
#Selecting multiple columns using .loc
second_row6 = df.loc[3:4,['OPM remarks','Assessor Remarks']]
print(second_row6)
#Selecting a slice of columns using .loc
second_row7 = df.loc[2:5,'Residential Type':'Serial Number']
print(second_row7)
#Combined row and column selection using .loc
second_row8 = df.loc[df['Town'] == 'OXFORD STREET', 'Sale Amount']
print(second_row8)
